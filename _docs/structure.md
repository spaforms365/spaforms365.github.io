...
* SPA Form has built-in overall lifecycle defined as <b>[state-machine workflow](/docs/usage/#formstates){:target="_blank"}</b> and enabled via <code>buttons</code> component included into system library. 
